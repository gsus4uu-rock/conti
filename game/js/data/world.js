...
(function (G) {
  ...
  /* ===========================================================
     ★★★ 운영자용 스위치 ★★★
     지금 아이들에게 열어 줄 곳을 여기서 정합니다.
     아래 배열에 있는 지역만 갈 수 있습니다.

     다음 챕터를 열어 줄 때:
       ① CHAPTER 배열에 지역 id 를 추가하고
       ② CHAPTER_NAME / CHAPTER_GOAL 문구를 고친 뒤
       ③ 커밋해서 배포하면 끝입니다.
     (급하면 운영자 페이지에서 "지역 개방" 선물을 보내도 됩니다)
     =========================================================== */
  G.CHAPTER = ['village', 'meadow', 'forest'];
  G.CHAPTER_NO = 1;
  G.CHAPTER_NAME = '제1장 — 속삭이는 숲';
  G.CHAPTER_GOAL = 'boss_goblin';   // 이걸 잡으면 이번 장 완결
  G.CHAPTER_END = [
    '고블린 두목이 쓰러지자 숲이 조용해졌다.',
    '나무들이 더 이상 속삭이지 않았다.',
    '',
    '마을로 돌아가는 길에 하늘을 올려다봤다.',
    '붉은 균열은 여전히 저기 있다. 아직도 아득히 멀다.',
    '',
    '하지만 처음 집을 나섰을 때보다는, 조금 가까워졌다.',
    '',
    '━━━━━━━━━━━━━━━━━━',
    '  제1장 「속삭이는 숲」 완결',
    '━━━━━━━━━━━━━━━━━━',
    '',
    '다음 이야기는 준비 중입니다.',
    '그동안 숲에서 더 강해지거나, 못 받은 의뢰를 마저 하거나,',
    '검을 더 키워 두세요. 다음 장은 만만치 않을 겁니다.'
  ];

  G.inCurrentChapter = function (regionId) {
    return G.CHAPTER.indexOf(regionId) >= 0;
  };
  ...
  var M = {
    ...
    /* ---- 꿈 오프닝 전용 ---- */
    neros_dream: { name: '마왕 네로스', sprite: 'neros', lv: 99, hp: 999999, atk: 9999, def: 400, spd: 99,
                  exp: 0, gold: 0, boss: true, drops: [],
                  flavor: '산 하나만 한 그림자가 천천히 고개를 숙여 이쪽을 내려다봤다.' },
